            ...
            <form class="layui-form" id="uploadForm" method="post" action="" lay-filter="component-form-group" enctype="multipart/form-data">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" value="<?= $name ?>" lay-verify="required" autocomplete="off" class="layui-input" readonly disabled>
                    </div>
                </div>
                <?php endif; ?>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="name" value="<?php if(isset($res['name'])) { echo $res['name']; } ?>" lay-verify="required" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox" name="is_menu" lay-skin="switch" lay-text="是|否" <?php if(isset($res['is_menu']) && $res['is_menu'] == '1') { echo 'checked'; } ?>>
                    </div>
                </div>
